"""
YLYI Insights Bot — local, no OpenAI.
...
REDIRECT = (
    "I can only answer questions about the PNWU Library's service activity "
    "and student satisfaction surveys. For other information, "
...
def answer(question: str) -> str:
    ...
    if not question or not question.strip():
        return "Ask me about Service Activity (Book a Librarian appointments) or the PNWU Student Satisfaction Surveys."
